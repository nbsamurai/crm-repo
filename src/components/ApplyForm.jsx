      ...
      <div className="bg-[#f3f4f6] min-h-screen py-20 px-6 flex items-center justify-center">
        ...
        >
          ...
          <p className="text-[#6b7280] mb-6">
            ...
            <span className="text-[#e05d38] font-semibold">{plan}</span> plan.
  ...
  return (
    <div className="bg-[#f3f4f6] min-h-screen">
      <div className="max-w-7xl mx-auto px-6 py-20 lg:py-32">
        <Link
          to="/pricing"
          className="inline-flex items-center text-[#333333] hover:text-[#e05d38] mb-8 transition-colors"
        >
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          >
            <h1 className="text-4xl md:text-5xl font-bold text-[#333333] mb-6 leading-tight">
              Apply for <span className="text-[#e05d38]">{plan}</span> Plan
            </h1>
            <p className="text-xl text-[#6b7280] mb-8 leading-relaxed">
              You are just one step away from streamlining your workflow. Fill
              out the form below to get started with the {plan} plan.
            </p>

            <div className="space-y-6">
              <div className="bg-[#f3f4f6] p-6 rounded-xl border border-gray-700">
                <h3 className="text-xl font-semibold text-[#333333] mb-2">
                  What happens next?
                </h3>
                <ul className="space-y-4 mt-4">
                  <li className="flex items-start text-[#6b7280]">
                    <span className="shrink-0 w-6 h-6 rounded-full bg-[#e05d38]/20 text-[#6b7280] flex items-center justify-center mr-3 text-sm font-bold">
                      1
                    </span>
          ...
          <motion.div
            ...
            className="bg-[#f3f4f6] p-8 md:p-10 rounded-2xl border border-gray-700 shadow-2xl"
          >
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  required
                  className="w-full bg-[#f3f4f6] border border-gray-600 text-[#333333] rounded-lg px-4 py-3 focus:outline-none focus:border-[#e05d38] focus:ring-1 focus:ring-[#e05d38] transition-colors"
