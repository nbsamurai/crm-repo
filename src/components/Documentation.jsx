    ...
    <div className="font-sans text-[#333333] bg-[#f3f4f6] min-h-screen">
      <div className="bg-linear-to-br from-[#e0f7fa] via-[#f3e5f5] to-[#fff8e1] py-20 px-6 text-center">
        ...
        <p className="text-xl text-[#6b7280]">
          Comprehensive guide to features, configuration, and usage.
        </p>
      </div>
      ...
      <div className="max-w-7xl mx-auto px-6 py-12 grid grid-cols-1 md:grid-cols-4 gap-12">
        ...
        <div className="col-span-1 md:col-span-3 space-y-16">
          ...
          <section id="introduction" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              <p className="text-lg leading-relaxed text-[#6b7280] mb-6">
                The Customer Relationship Management (CRM) system helps
                organizations manage customer data, track interactions, automate
                sales processes, and improve customer relationships. It provides
                a centralized platform for sales, marketing, and support teams
                to collaborate efficiently.
              </p>
              <p className="text-lg leading-relaxed text-[#6b7280]">
                This document explains the core features, configuration steps,
                and usage guidelines for the CRM.
              </p>
            </div>
          </section>
          ...
          <section id="system-overview" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2] mb-8">
              <p className="text-lg leading-relaxed text-[#6b7280] mb-4">
                The CRM consists of the following main modules:
              </p>
              <ul className="list-disc list-inside space-y-2 text-[#6b7280] mb-6 ml-4">
              ...
              <p className="text-lg leading-relaxed text-[#6b7280]">
                Each module is designed to support the complete customer
                lifecycle.
              </p>
            </div>
            <div className="grid md:grid-cols-2 gap-6">
              <img
                ...
                className="rounded-xl shadow-lg hover:shadow-2xl transition-shadow duration-300 w-full object-cover h-64 border border-gray-700"
              />
              <img
                src={crm2}
                alt="CRM Analytics"
          ...
          <section id="core-modules" className="scroll-mt-24">
            ...
            <div className="space-y-8">
              {/* 3.1 Contacts */}
              <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
                <h3 className="text-2xl font-semibold mb-4 text-[#e05d38]">
                  3.1 Contacts Management
                </h3>
                <p className="text-[#6b7280] mb-4">
                  The Contacts module stores all customer and prospect
                  information in one place.
                </p>
                <h4 className="font-semibold mb-2 text-[#333333]">
                  Key Functions:
                </h4>
              ...
              <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
                ...
                <p className="text-[#6b7280] mb-4">
                  Leads represent potential customers who have not yet been
                  qualified.
                </p>
                <h4 className="font-semibold mb-2 text-[#333333]">
                  Key Functions:
                ...
                <ul className="list-disc list-inside text-[#6b7280] space-y-1 ml-2">
                  <li>
                    Capture leads manually or through imports and integrations
                  </li>
              ...
              <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
                <h3 className="text-2xl font-semibold mb-4 text-[#e05d38]">
                  3.3 Sales Pipeline & Opportunities
                </h3>
                <p className="text-[#6b7280] mb-4">
                  The Sales Pipeline visualizes the sales process from initial
                  contact to deal closure.
                </p>
                <h4 className="font-semibold mb-2 text-[#333333]">
                  Key Functions:
                </h4>
                <ul className="list-disc list-inside text-[#6b7280] space-y-1 ml-2">
                  <li>
                    Create opportunities with deal value and expected close date
                  </li>
                ...
                <div className="mt-8">
                  <img
                    ...
                    className="rounded-xl shadow-lg w-full object-cover h-64 border border-gray-700"
                  />
                </div>
              </div>
              ...
              <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
                ...
                <p className="text-[#6b7280] mb-4">
                  Activities help users manage daily work and follow-ups.
                </p>
                <h4 className="font-semibold mb-2 text-[#333333]">
                  Key Functions:
                </h4>
          ...
          <section id="automation" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              ...
              <ul className="list-disc list-inside text-[#6b7280] space-y-1 ml-2 mb-4">
              ...
              <p className="text-[#6b7280] italic">
                Workflows can be customized based on business rules.
              </p>
            </div>
          </section>
          ...
          <section id="reports" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              <p className="text-[#6b7280] mb-4">
                The Reports module provides insights into sales and customer
                performance.
              </p>
              <h4 className="font-semibold mb-2 text-[#333333]">
                Available Reports:
              ...
              <p className="text-[#6b7280]">
                Reports can be filtered, exported, and shared.
              </p>
            </div>
          </section>
          ...
          <section id="user-management" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              <p className="text-[#6b7280] mb-4">
                Administrators can control system access using roles and
                permissions.
              </p>
              <h4 className="font-semibold mb-2 text-[#333333]">Features:</h4>
              <ul className="list-disc list-inside text-[#6b7280] space-y-1 ml-2">
          ...
          <section id="data-import" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              <p className="text-[#6b7280] mb-4">
                The CRM supports data migration and sharing.
              </p>
              <h4 className="font-semibold mb-2 text-[#333333]">Options:</h4>
              <ul className="list-disc list-inside text-[#6b7280] space-y-1 ml-2">
          ...
          <section id="security" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              <p className="text-[#6b7280] mb-4">
                The CRM ensures secure handling of customer data.
              </p>
              <h4 className="font-semibold mb-2 text-[#333333]">
                Security Measures:
              </h4>
          ...
          <section id="best-practices" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2] border-l-4 border-l-[#e05d38]">
              <ul className="list-none space-y-3 text-lg text-[#6b7280]">
                <li className="flex items-start gap-3">
                  <span className="text-[#e05d38] font-bold">✓</span> Keep
                  customer data accurate and updated
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#e05d38] font-bold">✓</span> Use
                  automation to reduce repetitive tasks
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#e05d38] font-bold">✓</span> Review
                  reports regularly to track performance
                </li>
                <li className="flex items-start gap-3">
                  <span className="text-[#e05d38] font-bold">✓</span> Train
                  users on standardized workflows
                </li>
              </ul>
            </div>
          </section>
          ...
          <section id="support" className="scroll-mt-24">
            ...
            <div className="bg-[#ffffff] p-8 rounded-2xl shadow-lg border border-[#dcdfe2]">
              ...
              <div className="grid md:grid-cols-3 gap-6 text-center">
                <div className="bg-[#ffffff] p-6 rounded-xl border border-[#dcdfe2] hover:border-[#e05d38] transition-colors">
                  <h5 className="font-bold text-[#e05d38] mb-2">In-app</h5>
                  <p className="text-sm text-[#6b7280]">Tooltips and guides</p>
                </div>
                <div className="bg-[#ffffff] p-6 rounded-xl border border-[#dcdfe2] hover:border-[#e05d38] transition-colors">
                  <h5 className="font-bold text-[#e05d38] mb-2">Online</h5>
                  <p className="text-sm text-[#6b7280]">
                    Documentation and FAQs
                  </p>
                </div>
                <div className="bg-[#ffffff] p-6 rounded-xl border border-[#dcdfe2] hover:border-[#e05d38] transition-colors">
                  <h5 className="font-bold text-[#e05d38] mb-2">Support</h5>
                  <p className="text-sm text-[#6b7280]">Technical issues</p>
                </div>
              </div>
            </div>
          </section>
